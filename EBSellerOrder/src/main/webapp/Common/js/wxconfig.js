$(function(){  
    ...
    $.ajax({  
    	type: 'POST',
    	//url:'http://localhost:8080/EBSellerOrder/GetSignature',
    	url:'http://supplywechat.tunnel.qydev.com/EBSellerOrder/GetSignature',
    	//url:'http://supplierwechat.free.ngrok.cc/EBSellerOrder/GetSignature',
    	dataType: 'json',  
        data: {"url" : url1},  
